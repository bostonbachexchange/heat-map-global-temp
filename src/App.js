...
function App() {
  ...
  function drawHeatMap () {
    ...
    const svg = d3.select('body #container')
      .append("svg")
      .attr('width', width)
      .attr('height', height)
    ...
    svg
      ...
      .attr('width', ( width - (2 * padding))/ (d3.max(data, (d)=> d.year) - d3.min(data, (d)=> d.year)))
  ...
  return (
    <div className="App">
      ...
      <p id="description">1753 - 2015: base temperature {baseTemp && baseTemp}℃</p>
